...
//  CXH
//
//  Created by hao peng on 2017/4/18.
...
protocol WaterFlowViewLayoutDelegate:NSObjectProtocol
{
    ...
    ///width是瀑布流每列的宽度
    func waterFlowViewLayout(_ waterFlowViewLayout:WaterFlowViewLayout,heightForWidth:CGFloat,atIndextPath:IndexPath)->CGFloat
}
class WaterFlowViewLayout: UICollectionViewLayout {
    ...
    override func prepare() {
        ...
        self.sectionInsert=UIEdgeInsets(top:margin, left:margin, bottom:margin,right:margin)
        //设置布局
        //需要清空字典里面的值
        for key in 0..<column
        {
